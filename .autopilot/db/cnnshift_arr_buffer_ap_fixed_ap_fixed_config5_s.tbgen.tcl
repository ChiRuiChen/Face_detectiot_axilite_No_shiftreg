set moduleName cnnshift_arr_buffer_ap_fixed_ap_fixed_config5_s
set isTopModule 0
...
set C_modelName {cnnshift_arr_buffer<ap_fixed,ap_fixed,config5>}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 16 regular {array 32 { 1 3 } 1 1 }  }
	{ output_V int 16 regular {array 288 { 2 3 } 1 1 }  }
}
...
set portList { 
	...
	{ output_V_address0 sc_out sc_lv 9 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.linebuffer_V_4_U", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "11545", "Max" : "11545"}
	, {"Name" : "Interval", "Min" : "11545", "Max" : "11545"}
]}
...
set Spec2ImplPortList { 
	...
	output_V { ap_memory {  { output_V_address0 mem_address 1 9 }  { output_V_ce0 mem_ce 1 1 }  { output_V_we0 mem_we 1 1 }  { output_V_d0 mem_din 1 16 }  { output_V_q0 mem_dout 0 16 } } }
}
