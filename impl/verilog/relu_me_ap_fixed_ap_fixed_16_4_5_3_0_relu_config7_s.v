...
module relu_me_ap_fixed_ap_fixed_16_4_5_3_0_relu_config7_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
assign i_fu_62_p2 = (i_0_reg_45 + 15'd1);

assign icmp_ln1494_fu_72_p2 = (($signed(tmp_V_reg_96) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign icmp_ln60_fu_56_p2 = ((i_0_reg_45 == 15'd28800) ? 1'b1 : 1'b0);
...
endmodule //relu_me_ap_fixed_ap_fixed_16_4_5_3_0_relu_config7_s
