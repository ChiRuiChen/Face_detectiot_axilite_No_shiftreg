...
//------------------------Parameter----------------------
localparam
    ADDR_IN_V_BASE  = 15'h2000,
    ADDR_IN_V_HIGH  = 15'h3fff,
    ADDR_OUT_V_BASE = 15'h4000,
    ADDR_OUT_V_HIGH = 15'h400f,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,
    WRRESET         = 2'd3,
...
assign int_in_V_address1  = ar_hs? raddr[12:2] : waddr[12:2];
