...
set solution_dir "/home/crchen/yolo_hls4ml/custom_qkeras_combined_axi_lite/myproject_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {cnnshift_arr_buffer_ap_fixed_ap_fixed_config2_s_linebuffebkb
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {}
        memories "in_V {base_address 8192 range 8192} out_V {base_address 16384 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 11991005 II x}
