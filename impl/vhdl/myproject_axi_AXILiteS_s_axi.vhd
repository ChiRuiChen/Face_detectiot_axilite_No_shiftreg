...
architecture behave of myproject_axi_AXILiteS_s_axi is
    ...
    constant ADDR_IN_V_BASE  : INTEGER := 16#2000#;
    constant ADDR_IN_V_HIGH  : INTEGER := 16#3fff#;
    constant ADDR_OUT_V_BASE : INTEGER := 16#4000#;
    constant ADDR_OUT_V_HIGH : INTEGER := 16#400f#;
    ...
    -- memory signals
    signal int_in_V_address0   : UNSIGNED(10 downto 0);
    ...
    signal int_in_V_address1   : UNSIGNED(10 downto 0);
...
-- ----------------------- Memory logic ------------------
    -- in_V
    int_in_V_address0    <= SHIFT_RIGHT(UNSIGNED(in_V_address0), 1)(10 downto 0);
    ...
    int_in_V_address1    <= raddr(12 downto 2) when ar_hs = '1' else waddr(12 downto 2);
